                ...
                <div class="recent-banners">
                    <div class="header row">
                        <div class="left col-lg-8">
                            <h1>My recent Banners (230)</h1>
                        </div>
                        <div class="right col-lg-4">
                            <button class="create blue roundedd">Create banner</button>
                            <button class="view blue roundedd">View all</button>
                         </div>   
                    </div>
                    <div class="banner-slide row">
                        <div class="col-lg">
                            <div class="preview">
                                <img src="https://image.flaticon.com/icons/svg/117/117967.svg">
                            </div>    
                        </div>   
                        <div class="col-lg">
                            <div class="preview">
