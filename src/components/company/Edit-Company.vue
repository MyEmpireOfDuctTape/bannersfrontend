<template>
    <div class="fullpage container-fluid">
        <div class="row">
                ...
                <add-user v-on:company-changed="methodThatForcesUpdate($event)"></add-user>
                <editUser v-on:company-changed="methodThatForcesUpdate($event)" v-bind:firstName="currentUser.firstName" v-bind:lastName="currentUser.lastName"></EditUser>
                 <DeleteUser v-on:company-changed="methodThatForcesUpdate($event)" v-bind:user="editingUser"></DeleteUser>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-7 col-md-12 users">
                            ...
                            <div class="user row">
                                ...
                                <div class="col-lg-2 status">
                                    <template v-if="'admin' == currentAccessLevel">
                                   <div class="grey-dd">
                                            ...
                                            <ul>
                                                ...
                                                <!-- <li><a href="#">
                                                    ...
                                                    <li><a v-on:click="openDeleteUser($event, user)" href="#">
...
export default {
  ...
  data () {
    return {
      ...
      userstoupdate: [],
      editingUser: this.$store.getters.getUser,
    }
  },
  created(){
  ...
  methods:{
        ...
        setCurrentCompany(id){
            ...
            console.log(index)
            this.$store.commit('resetToken', this.$store.getters.getToken.accessToken)
            .then((response) => {
        ...
        async getUsers(){
            ...
            if(typeof this.currentCompany != null){
                    ...
                    _.forEach(this.users, (user) => {
                        this.userstoupdate.push({email: user.email, role: user.pivot.role})
                    })
