        ...
        <div class="row">
                ...
                <div class="banners container-fluid main-view">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="folders">
                            <div v-for="folder in folders" class="col-lg-2 col-md-3 col-sm-6">
                                <div class="folder">
                                    ...
                                    <div class="folder-bg">
                                        ...
                                        <span class="contents">Teli new internet campagin</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12">
                            <div class="preview">
                                ...
                                <span class="name">Folder name 2</span>
                                <span class="dimensions">20 banners</span>
                            </div>    
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12">
                            <div class="preview">
                                ...
                                <span class="name">Folder name 3</span>
                                <span class="dimensions">20 banners</span>
                            </div>    
                        </div>
