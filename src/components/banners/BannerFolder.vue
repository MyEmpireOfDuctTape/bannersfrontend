    ...
    <div class="fullpage container-fluid">
        <div class="row">
                ...
                <div class="banners main-view container-fluid">
                    ...
                    <span class="after">{{ $route.params.folderName }}</span>
                        ...
                        <div class="recent-templates file-view">
                            ...
                            <div class="preview">
                                <div class="square">
                                    ...
                                    <div class="edit-overlay Aligner up">
                                        <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 800 800" style="enable-background:new 0 0 800 800;" xml:space="preserve"> <g id="Desktop"> <g id="Banners---Folder-view" transform="translate(-371.000000, -392.000000)"> <g id="Group" transform="translate(371.000000, 392.000000)"> <path id="Shape" d="M717.3,360.3H82.7C60.8,360.3,43,378.1,43,400c0,21.9,17.8,39.7,39.7,39.7h634.7c21.9,0,39.7-17.8,39.7-39.7 C757,378.1,739.2,360.3,717.3,360.3z M428,110.7c15.5-15.5,15.5-40.6,0-56.1c-15.5-15.5-40.6-15.5-56.1,0L54.6,372 c-15.5,15.5-15.5,40.6,0,56.1L372,745.4c15.5,15.5,40.6,15.5,56.1,0c15.5-15.5,15.5-40.6,0-56.1L138.8,400L428,110.7z"/> </g> </g> </g> </svg>    
                                    </div>   
                                    </router-link> 
                                </div>     
                            </div>    
