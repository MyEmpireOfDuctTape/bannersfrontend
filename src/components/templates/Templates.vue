                                 ...
                                 <template v-for="(template, index) in templates.templates">
                                    ...
                                    <div class="template row">
                                        ...
                                        <div class="right col-lg-6">
                                            <div class="images">
                                                <div @mouseover="showTooltip(1, index)" @mouseout="showTooltip(1, index)" class="svg-wrapper popover-wrapper" data-popover="View Gallery of banners made with this template">  
                                            ...
                                            <div @mouseover="showTooltip(2, index)" @mouseout="showTooltip(2, index)" class="svg-wrapper popover-wrapper" data-popover="Edit the banners of this template">  
